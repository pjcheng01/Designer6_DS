...
;;;   REformatted and updated for AutoCAD Rell 11     July 1990
;;; --------------------------------------------------------------------------;
;;; DESCRIPTION
;;;
...
(defun 1LTXT ()
  ...
  (cond
    ...
    ((and (= j "Fit")     h)        (command "TEXT" j  pt pt2 h (rtd ang) s))
    ((and (= j "Fit")     (null h)) (command "TEXT" j  pt pt2 (rtd ang) s))
